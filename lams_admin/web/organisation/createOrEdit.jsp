		...
		<form:form action="../orgsave.do" method="post" modelAttribute="organisationForm" id="organisationForm" onsubmit="return warnIfRemoved()">
				...
				<table class="table table-condensed table-no-border">
					<tr>
						...
						<td><form:input path="name" size="40" cssClass="form-control" required="required" maxlength="240"/></td>
					</tr>
					<tr>
					<td><fmt:message key="admin.organisation.code"/> *</td>
						<td><form:input path="code" size="20" cssClass="form-control" required="required" maxlength="20"/></td>
					</tr>
					<tr>
