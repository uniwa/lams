...
<body class="stripes">
	...
	<lams:Page type="admin" title="${title}">
				...
				<form onsubmit="return loadSearchResults(0);">
					<p>
						<fmt:message key="admin.search"/>: <input id="term" type="text"/> <input type="submit" value="Αναζήτηση" /> or <a onclick="loadSearchResults(1);"><fmt:message key="msg.show.all.potential.users"/></a>
					</p>
				</form>
				<div class="listBoundingBox">
