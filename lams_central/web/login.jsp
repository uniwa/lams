...
<c:choose>
	...
	<div class="login-footer">
		<p class="text-muted text-center">
			...
			Copyright &copy; 2020 Πανελλήνιο Σχολικό Δίκτυο. Η υπηρεσία βασίστηκε στο λογισμικό <a href="/lams/www/copyright.jsp" target='copyright' onClick="openCopyRight()">LAMS</a>
		</p>
	</div>
