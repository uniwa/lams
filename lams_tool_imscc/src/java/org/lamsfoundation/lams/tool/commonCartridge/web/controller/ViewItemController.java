...
public class ViewItemController {
	...
	try {
	    ...
	    // Use the response Writer so the UTF-8 encoding set above is honoured;
	    // ServletOutputStream.println() only accepts ISO-8859-1 and throws
	    // CharConversionException on Greek names/titles in the launch form
